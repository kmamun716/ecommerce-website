        ...
        productData ? (<>
            <div className="px-6 md:px-16 lg:px-32 pt-14 space-y-10">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                    <div className="px-5 lg:px-16 xl:px-20">
                        <div className="rounded-lg overflow-hidden bg-gray-500/10 mb-4">
                            <Image
                                src={mainImage || productData.gallery[0]}
                                alt="alt"
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="flex items-center gap-2">
                            <StarRating rating={productData.avgRating} />
                            <span className="text-sm text-gray-600">({productData.avgRating.toFixed(1)})</span>
                        </div>
                ...
                <div className="flex flex-col items-center">
                    ...
                    <button className="btn btn-outline btn-sm mb-16" onClick={() => router.push('/products')}>
                        See more
                    </button>
                </div>
            </div>
